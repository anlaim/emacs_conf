...
;; Last Updated: Joseph 2011-12-03 14:24:31 星期六
...
(defun my-erlang-shell-mode-hook ()
  (local-set-key "\C-g"  '(lambda () "bury buffer and window" (interactive) (if (= 1 (count-windows)) (bury-buffer) (kill-buffer-and-window))) )
  )
