...
(setq-default folding-goto-key "\M-gg")
...
(setq-default folding-mode-prefix-key "\C-cf");;设置前缀为"C-c f"
...
(setq-default folding-default-keys-function 'joseph_bindingkeys_depend_on_default-keys)
