;;; -*- coding:utf-8 -*-
;; Last Updated: Joseph 2012-01-24 20:42:08 星期二
;;; byte complie
...
(setq-default recentf-exclude  `("\\.elc$" ,(regexp-quote (expand-file-name "~/.emacs.d/cache/"))  "^/tmp/" "/ssh:" "TAGS" "java_base.tag" ".erlang.cookie" "xhtml-loader.rnc"))
